...
import PlaygroundTabsContent from "../../components/PlaygroundTab/Tab";
...
import StudyPlayground from "../../components/Playground/Playground"
// Test study data
      ...
      <div id="page-content">
        <FilterProvider>
          <div className="container">
            ...
            <StudyFilters />
            <PlaygroundTabsContent  study={study}/>
            {/* <StudyTabs study={study} /> */}
            {/* <StudyPlayground study={study.studyData["(T) Combined"]}/> */}
          </div>
        </FilterProvider>
      </div>
    </>
...
export default PlaygroundStudyDetail;
